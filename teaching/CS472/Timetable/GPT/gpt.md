...
In the next three sections, we provide **concrete examples on how developers are using ChatGPT**. We demonstrate 2 uses how developers incorporate code from ChatGPT:
 ...
 - **Use case 1:** Developers incorporate the entire code snippet suggested by ChatGPT into the pull request. This is shown in `Example 1`
 - **Use case 2:** Developers pick part of the code snippet suggested by ChatGPT and modifies it to fit their requirement, as illustrated in `Example 2`
...
In the example above, the developer utilized the code generated by ChatGPT "as-is". However, in typical scenarios, you usually need to modify the code and tailor it to fit your specific use case. 

## Example 2: 
The following example illustrates this scenario, where the developer customizes the code to suit their requirements
...
<p style="text-align:center"><img src="/teaching/CS472/Timetable/GPT/example-1-4.png" alt="ShareChatGPTConversations" style="max-width:900px;max-height:900px;" align="center"></p>

## Example 3: Documentation and Technical Writing
